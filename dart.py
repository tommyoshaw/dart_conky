...
def main():
    ...
    line_format = '{:<10s}  {:>10s}  {:>5s}  {:>15s}'
    #print line_format.format("Destination", "Due", "Departs", "Leave", "")
    print line_format.format("Leave in", "Departs", "Due", "Destination", "")
    for train in trains:
        if train.is_dart and train.direction == args.direction:
            ...
            print line_format.format(
                leave_in.ljust(10),
                train.dep_time.rjust(10),
                "%s min".rjust(10) % train.due_in,
		train.destination.rjust(10)
            )
